...
# ==========================================
GEN_MODEL_PATH = "fine_tuned_model_nnmd_memes_v2" # Можно имя папки или путь
GEN_AMOUNT = 1
GEN_PROMPT_FILE = "diarygpt.csv"     # Откуда брать идеи (если None, то рандом)
